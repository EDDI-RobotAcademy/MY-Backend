...
urlpatterns = [
    ...
    path('list-by-title', FreeCommunityView.as_view({'post': 'listByTitle'}), name='list-by-title'),
    path('list-by-content', FreeCommunityView.as_view({'post': 'listByContent'}), name='list-by-content'),
    path('list-by-nickname', FreeCommunityView.as_view({'post': 'listByNickname'}), name='list-by-nickname'),
