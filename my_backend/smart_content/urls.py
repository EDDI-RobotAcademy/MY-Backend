...
urlpatterns = [
    ...
    path('list-my-content', SmartContentView.as_view({'post': 'listByAccountId'}), name='list-my-content'),
    path('list-user-content', SmartContentView.as_view({'post': 'listByNickname'}), name='list-user-content'),
]